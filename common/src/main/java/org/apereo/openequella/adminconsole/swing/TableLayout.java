...
public class TableLayout implements LayoutManager2 {
  ...
  private static final String ERROR_CONSTRAINT_NOT_RECTANGLE =
      "Constraint must be an instance of java.awt.Rectangle";
  private static final String ERROR_CONSTRAINT_OUT_OF_BOUNDS =
      "Constraint is placing the component outside of the layouts defined rows and columns";
  private static final String ERROR_ADD_BY_STRING_NOT_SUPPORTED =
      "You need to add the component with a Rectangle as a constraint, not a String!";
